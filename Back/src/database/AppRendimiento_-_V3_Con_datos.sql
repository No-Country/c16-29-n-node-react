...
--
-- Estructura de tabla para la tabla `StudentSubjets`
--

CREATE TABLE `StudentSubjets` (
  `id` int(11) NOT NULL,
  `subject_id` int(11) NOT NULL,
  `student_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Volcado de datos para la tabla `StudentSubjets`
--

INSERT INTO `StudentSubjets` (`id`, `subject_id`, `student_id`) VALUES
(1, 1, 2);
...
--
-- Indices de la tabla `StudentSubjets`
--
ALTER TABLE `StudentSubjets`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `StudentSubjets`
--
ALTER TABLE `StudentSubjets`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
