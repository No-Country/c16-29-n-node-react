...
export const Profesor = () => {
  ...
  const handleCreateProfesor = () => {
    ...
    setCurrentForm({
      ...
      onSubmit: (formData) => {
        ...
        setTimeout(() => {
          setAlert({
            message: "1 Profesor registrado con éxito.",
            type: "success",
          });
  ...
  return (
    <div className="w-full h-full">
      <div className="p-5">
        <h1 className="text-3xl font-semibold text-[#123259]">
          Profesores
        </h1>
        <button
          className="px-4 py-2 text-white bg-purple-600 hover:bg-purple-700 rounded transition duration-300 ease-in-out m-4"
